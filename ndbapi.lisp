...
(cffi:defcstruct #.(swig-lispify "ndberror_struct" 'classname)
	(#.(swig-lispify "status" 'slotname) #.(swig-lispify "ndberror_status_enum" 'enumname))
	(#.(swig-lispify "classification" 'slotname) #.(swig-lispify "ndberror_classification_enum" 'enumname))
	(#.(swig-lispify "code" 'slotname) :int)
...
(cffi:defcstruct #.(swig-lispify "NdbError" 'classname)
	(#.(swig-lispify "status" 'slotname) :pointer)
	(#.(swig-lispify "classification" 'slotname) :pointer)
	(#.(swig-lispify "code" 'slotname) :int)
	(#.(swig-lispify "mysql_code" 'slotname) :int)
	(#.(swig-lispify "message" 'slotname) :string)
	(#.(swig-lispify "details" 'slotname) :string)
...
(cffi:defcfun ("_wrap_NdbDictionary_getEmptyBitmask" #.(swig-lispify "NdbDictionary_getEmptyBitmask" 'function)) :pointer)
...
(cffi:defcstruct #.(swig-lispify "RecordSpecification" 'classname)
	...
	(#.(swig-lispify "column" 'slotname) :pointer)
	(#.(swig-lispify "offset" 'slotname) :unsigned-int)
	(#.(swig-lispify "nullbit_byte_offset" 'slotname) :unsigned-int)
	(#.(swig-lispify "nullbit_bit_in_byte" 'slotname) :unsigned-int)
	(#.(swig-lispify "column_flags" 'slotname) :unsigned-int))
...
(cffi:defcstruct #.(swig-lispify "AutoGrowSpecification" 'classname)
	(#.(swig-lispify "min_free" 'slotname) :unsigned-int)
	(#.(swig-lispify "max_size" 'slotname) :unsigned-long-long)
...
(cffi:defcstruct #.(swig-lispify "List" 'classname)
	(#.(swig-lispify "__assign__" 'slotname) :pointer)
	(#.(swig-lispify "count" 'slotname) :unsigned-int)
	(#.(swig-lispify "elements" 'slotname) :pointer)
	(#.(swig-lispify "sortById" 'slotname) :pointer)
	(#.(swig-lispify "sortByName" 'slotname) :pointer))
...
(cffi:defcstruct #.(swig-lispify "Element" 'classname)
	...
	(#.(swig-lispify "store" 'slotname) :pointer)
	(#.(swig-lispify "temp" 'slotname) :unsigned-int)
	(#.(swig-lispify "database" 'slotname) :string)
	(#.(swig-lispify "schema" 'slotname) :string)
	(#.(swig-lispify "name" 'slotname) :string)
	(#.(swig-lispify "compareByName" 'slotname) :pointer)
	(#.(swig-lispify "compareById" 'slotname) :pointer))
...
(cffi:defcfun ("_wrap_new_Ndb__SWIG_0" #.(swig-lispify "new_Ndb/SWIG-0" 'function)) :pointer
  (ndb_cluster_connection :pointer)
  (aCatalogName :string)
  (aSchemaName :string))

(cffi:defcfun ("_wrap_new_Ndb__SWIG_1" #.(swig-lispify "new_Ndb/SWIG-1" 'function)) :pointer
  (ndb_cluster_connection :pointer)
  (aCatalogName :string))

(cffi:defcfun ("_wrap_new_Ndb__SWIG_2" #.(swig-lispify "new_Ndb/SWIG-2" 'function)) :pointer
  (ndb_cluster_connection :pointer))
...
(cffi:defcstruct #.(swig-lispify "EventBufferMemoryUsage" 'classname)
	(#.(swig-lispify "allocated_bytes" 'slotname) :unsigned-int)
	(#.(swig-lispify "used_bytes" 'slotname) :unsigned-int)
	(#.(swig-lispify "usage_percent" 'slotname) :unsigned-int))

(cffi:defcstruct #.(swig-lispify "Key_part_ptr" 'classname)
	(#.(swig-lispify "ptr" 'slotname) :pointer)
	(#.(swig-lispify "len" 'slotname) :unsigned-int))

(cffi:defcstruct #.(swig-lispify "PartitionSpec" 'classname)
	(#.(swig-lispify "size" 'slotname) :pointer)
	(#.(swig-lispify "type" 'slotname) :unsigned-int))

(cffi:defcstruct #.(swig-lispify "PartitionSpec_v1" 'classname)
	(#.(swig-lispify "type" 'slotname) :unsigned-int))

(cffi:defcstruct #.(swig-lispify "TupleIdRange" 'classname)
	(#.(swig-lispify "m_first_tuple_id" 'slotname) :unsigned-long-long)
	(#.(swig-lispify "m_last_tuple_id" 'slotname) :unsigned-long-long)
	(#.(swig-lispify "m_highest_seen" 'slotname) :unsigned-long-long)
	(#.(swig-lispify "reset" 'slotname) :pointer))

(cffi:defcstruct #.(swig-lispify "Free_list_usage" 'classname)
	(#.(swig-lispify "m_name" 'slotname) :string)
	(#.(swig-lispify "m_created" 'slotname) :unsigned-int)
	(#.(swig-lispify "m_free" 'slotname) :unsigned-int)
	(#.(swig-lispify "m_sizeof" 'slotname) :unsigned-int))
...
(cffi:defcstruct #.(swig-lispify "GetValueSpec" 'classname)
	(#.(swig-lispify "column" 'slotname) :pointer)
	(#.(swig-lispify "appStorage" 'slotname) :pointer)
	(#.(swig-lispify "recAttr" 'slotname) :pointer))
...
(cffi:defcstruct #.(swig-lispify "OperationOptions" 'classname)
	(#.(swig-lispify "size" 'slotname) :pointer)
	(#.(swig-lispify "optionsPresent" 'slotname) :unsigned-long-long)
	(#.(swig-lispify "abortOption" 'slotname) :pointer)
	(#.(swig-lispify "extraGetValues" 'slotname) :pointer)
	(#.(swig-lispify "numExtraGetValues" 'slotname) :unsigned-int)
	(#.(swig-lispify "extraSetValues" 'slotname) :pointer)
	(#.(swig-lispify "numExtraSetValues" 'slotname) :unsigned-int)
	(#.(swig-lispify "partitionId" 'slotname) :unsigned-int)
	(#.(swig-lispify "interpretedCode" 'slotname) :pointer)
	(#.(swig-lispify "anyValue" 'slotname) :unsigned-int)
...
(cffi:defcstruct #.(swig-lispify "ScanOptions" 'classname)
	(#.(swig-lispify "size" 'slotname) :pointer)
	(#.(swig-lispify "optionsPresent" 'slotname) :unsigned-long-long)
	(#.(swig-lispify "scan_flags" 'slotname) :unsigned-int)
	(#.(swig-lispify "parallel" 'slotname) :unsigned-int)
	(#.(swig-lispify "batch" 'slotname) :unsigned-int)
	(#.(swig-lispify "extraGetValues" 'slotname) :pointer)
	(#.(swig-lispify "numExtraGetValues" 'slotname) :unsigned-int)
	(#.(swig-lispify "partitionId" 'slotname) :unsigned-int)
	(#.(swig-lispify "interpretedCode" 'slotname) :pointer)
	(#.(swig-lispify "customData" 'slotname) :pointer)
	(#.(swig-lispify "partitionInfo" 'slotname) :pointer)
	(#.(swig-lispify "sizeOfPartInfo" 'slotname) :unsigned-int))
...
(cffi:defcstruct #.(swig-lispify "OldApiBoundInfo" 'classname)
	(#.(swig-lispify "highestKey" 'slotname) :unsigned-int)
	(#.(swig-lispify "highestSoFarIsStrict" 'slotname) :pointer)
	(#.(swig-lispify "keysPresentBitmap" 'slotname) :unsigned-int)
...
(cffi:defcstruct #.(swig-lispify "Error" 'classname)
	(#.(swig-lispify "line" 'slotname) :int)
	(#.(swig-lispify "extra" 'slotname) :int))

(cffi:defcstruct #.(swig-lispify "CacheInfo" 'classname)
	(#.(swig-lispify "m_count" 'slotname) :unsigned-int)
	(#.(swig-lispify "m_valid" 'slotname) :unsigned-int)
	(#.(swig-lispify "m_sampleCount" 'slotname) :unsigned-int)
	(#.(swig-lispify "m_totalBytes" 'slotname) :unsigned-int)
	(#.(swig-lispify "m_save_time" 'slotname) :unsigned-long-long)
	(#.(swig-lispify "m_sort_time" 'slotname) :unsigned-long-long)
	(#.(swig-lispify "m_ref_count" 'slotname) :unsigned-int))

(cffi:defcstruct #.(swig-lispify "Head" 'classname)
	(#.(swig-lispify "m_found" 'slotname) :int)
	(#.(swig-lispify "m_eventType" 'slotname) :int)
	(#.(swig-lispify "m_indexId" 'slotname) :unsigned-int)
	(#.(swig-lispify "m_indexVersion" 'slotname) :unsigned-int)
	(#.(swig-lispify "m_tableId" 'slotname) :unsigned-int)
	(#.(swig-lispify "m_fragCount" 'slotname) :unsigned-int)
	(#.(swig-lispify "m_valueFormat" 'slotname) :unsigned-int)
	(#.(swig-lispify "m_sampleVersion" 'slotname) :unsigned-int)
	(#.(swig-lispify "m_loadTime" 'slotname) :unsigned-int)
	(#.(swig-lispify "m_sampleCount" 'slotname) :unsigned-int)
	(#.(swig-lispify "m_keyBytes" 'slotname) :unsigned-int))

(cffi:defcstruct #.(swig-lispify "Bound" 'classname)
	(#.(swig-lispify "m_impl" 'slotname) :pointer))

(cffi:defcstruct #.(swig-lispify "Range" 'classname)
	(#.(swig-lispify "m_bound1" 'slotname) :pointer)
	(#.(swig-lispify "m_bound2" 'slotname) :pointer))
...
(cffi:defcstruct #.(swig-lispify "Head" 'classname)
	(#.(swig-lispify "varsize" 'slotname) :unsigned-short)
	(#.(swig-lispify "reserved" 'slotname) :unsigned-short)
