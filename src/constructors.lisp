...
(make-finalize-wrapper ndbapi.ffi::new-ndb-interpreted-code/swig-4 (arg0 buffer buffer-word-size) ndb-init)
(make-finalize-wrapper ndbapi.ffi::new-ndb-interpreted-code/swig-5 (arg0 buffer) ndb-init)
(make-finalize-wrapper ndbapi.ffi::new-ndb-interpreted-code/swig-6 (arg0) ndb-init)
